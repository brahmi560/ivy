	...
	*/
	...
	if( !function_exists('gdlr_add_import_action') ){
		function gdlr_add_import_action(){
			...
			update_option( 'page_on_front', 3261 );
	...
	//	'widget_categories', 'widget_gdlr-flickr-widget', 'widget_gdlr-course-category-widget',
	//  'widget_gdlr-lms-popular-course-widget', 'widget_gdlr-lms-recent-course-widget',

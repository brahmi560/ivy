...
{name: "top-bar-bottom-border", selector: ".top-navigation-wrapper{ border-color: #gdlr#; }"},
{name: "header-background-color", selector: ".gdlr-header-inner, .header-style-transparent .gdlr-fixed-header .gdlr-header-inner{ background-color: #gdlr#; }@media only screen and (max-width: 767px) { .body-wrapper.header-style-transparent .gdlr-header-inner{ background-color: #gdlr#; } }"},
...
{name: "float-navigation-bottom-border", selector: ".gdlr-fixed-header{ border: 2px solid #gdlr#; }"},
...
{name: "stunning-text-button-text", selector: ".gdlr-stunning-text-item.type-normal .stunning-text-button{ color: #gdlr#; }"},
{name: "stunning-text-button-background", selector: ".gdlr-stunning-text-item.type-normal .stunning-text-button{ background-color: #gdlr#; }"},
...
{name: "blog-info-head-color", selector: ".blog-info .gdlr-head{ color: #gdlr#; }"},
{name: "blog-date-day", selector: ".blog-date-wrapper .blog-date-day{ color: #gdlr#; }"},
{name: "blog-date-month", selector: ".blog-date-wrapper .blog-date-month{ color: #gdlr#; }"},
{name: "blog-author-background", selector: ".gdlr-post-author .gdlr-post-author-inner{ background-color: #gdlr#; }"},
...
{name: "blog-widget-bottom-border", selector: ".gdlr-blog-widget{ border-color: #gdlr#; }"},
...
{name: "portfolio-filter-active-text", selector: ".portfolio-item-filter a.active{ color: #gdlr#; }"},
...
{name: "portfolio-thumbnail-icon-background", selector: ".portfolio-thumbnail .portfolio-icon{ background-color: #gdlr#; }"},
...
{name: "modern-portfolio-content-background", selector: ".portfolio-item-holder .gdlr-modern-portfolio .portfolio-content-wrapper{ background: #gdlr#; }"},
{name: "modern-portfolio-bottom-border", selector: ".portfolio-item-holder .gdlr-modern-portfolio .portfolio-content-wrapper{ border-color: #gdlr#; }"},

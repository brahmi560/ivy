			...
			while($query->have_posts()){ $query->the_post();
				...
				if( !empty($image_id) ){
					...
					if( $settings['style'] == 'no-excerpt' ){
						...
						$slide_data[$image_id]['caption'] .= '<i class="fa fa-calendar icon-calendar"></i>';
						...
						$slide_data[$image_id]['caption'] .= '<i class="fa fa-angle-right icon-angle-right" ></i>';
						$slide_data[$image_id]['caption'] .= '</div>';		
					}else{
						$slide_data[$image_id]['caption']  = '<div class="blog-info blog-date"><i class="fa fa-calendar icon-calendar"></i>';
						$slide_data[$image_id]['caption'] .= get_the_time($theme_option['date-format']);
						$slide_data[$image_id]['caption'] .= '</div>';
						$slide_data[$image_id]['caption'] .= '<div class="blog-info blog-comment"><i class="fa fa-comment icon-comment"></i>';

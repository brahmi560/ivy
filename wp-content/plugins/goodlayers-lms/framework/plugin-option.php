					...
					'plugin-style' => array(
						...
						'options' => array(
							...
							'course-info-style' => array(
								'title' => __('Single Course Info Style', 'gdlr-lms'),
								'type' => 'combobox',	
								'default' => 'style-1',
								'options' => array(

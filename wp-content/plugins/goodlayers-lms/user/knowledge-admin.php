...
<ul class="gdlr-lms-admin-list">
	...
	<li><a href="<?php echo esc_url(add_query_arg('type', 'kp-my-course')); ?>" ><?php _e('My Courses', 'gdlr-lms'); ?></a></li>
	<li><a href="<?php echo esc_url(add_query_arg('type', 'kp-scoring-status')); ?>" ><?php _e('Scoring Status', 'gdlr-lms'); ?></a></li>
<?php
...
?>	
	<li>
		<a href="<?php echo esc_url(add_query_arg('type', 'kp-manual-check-needed')); ?>" ><?php _e('Manual Check Needed', 'gdlr-lms'); ?></a>
		<?php 
	...
	<li><a href="<?php echo esc_url(add_query_arg('type', 'kp-earning')); ?>" ><?php _e('Earning', 'gdlr-lms'); ?></a></li>
</ul>

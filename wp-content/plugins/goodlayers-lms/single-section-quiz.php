	...
	<div class="gdlr-lms-content">
		...
		<?php 
			if( $authorization ){
				...
				echo '<h3>' . __('Section Quiz', 'gdlr-lms') . ' : ' . $gdlr_course_content[$lms_page-1]['section-name'] . '</h3>';
				...
				_e('You do not have a permission to access or retake this quiz.', 'gdlr-lms');
				echo '</p><p><a class="gdlr-lms-button cyan" href="' . get_permalink() . '" >';
				_e('Back to course', 'gdlr-lms');
				echo '</a></p></div>';
			}
		?>

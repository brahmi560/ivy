				...
				<table id="mapping-options" border="0">
					<tr>
						<?php if( $linking_enabled == 1 ): ?>
							<td valign="top"  width="50%" style="text-align:center; display: none;">
						...
						<td valign="top"  width="100%" style="text-align:center;">
							...
							<p style="font-size: 12px;"><?php printf( _wsl__( "PLEASE SELECT YOUR ROLE FROM THE BELOW OPTIONS AND THEN CONTINUE TO CREATE A NEW ACCOUNT", 'wordpress-social-login' ), $provider ); ?></p>
							<div class="radio" style="width:100%; height:80px;">
								<ul style="width:100%; height:100%; margin:auto; padding: 0;">
								  <li>

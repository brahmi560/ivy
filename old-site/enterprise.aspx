<%@ page title="" language="C#" masterpagefile="~/webmaster.master" autoeventwireup="true" inherits="enterprise, App_Web_npiis2vy" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <!--=== Interactive Slider ===-->
    <div class="breadcrumbs-v3 img-v1 ">
        <div class="container">
            <h1>Enterprise Partner Registration</h1>
            <p class="pull-right"><a href="index.aspx">Home </a>&nbsp/&nbsp<strong> Enterprise Partner Registration</strong> </p>
        </div>
    </div>
    <div class="container content">
        <div class="row">
            <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                <div class="reg-page">
                    <label>Enterprise Name<span class="color-red">*</span></label>
                    <asp:TextBox ID="txtPartner" runat="server" CssClass="form-control margin-bottom-20" placeholder="Enter Enterprise  Name" MaxLength="60" pattern="^[a-zA-Z ]+$" title="Invalid Entry" Required=""></asp:TextBox>
                    <label>Contact Person Name</label>
                    <asp:TextBox ID="txtContact" runat="server" CssClass="form-control margin-bottom-20" placeholder="Enter Contact Person Name" MaxLength="40" pattern="^[a-zA-Z ]+$" title="Invalid Entry" ></asp:TextBox>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Franchise partner details reigstered successfully.</p>
                </div>

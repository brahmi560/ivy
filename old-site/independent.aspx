<%@ page title="" language="C#" masterpagefile="~/webmaster.master" autoeventwireup="true" inherits="independent, App_Web_npiis2vy" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <!--=== Interactive Slider ===-->
    <div class="breadcrumbs-v3 img-v1 ">
        <div class="container">
            <h1>Independent Partner Registration</h1>
            <p class="pull-right"><a href="index.aspx">Home </a>&nbsp/&nbsp <strong>Independent Partner</strong> </p>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                <div class="reg-page">
                    ...
                    <asp:TextBox ID="txtPartner" runat="server" CssClass="form-control margin-bottom-20" placeholder="Enter Full Name" MaxLength="40" pattern="^[a-zA-Z ]+$" title="Invalid Entry"  Required=""></asp:TextBox>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Independent partner details reigstered successfully.</p>
                </div>

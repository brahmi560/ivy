...
$menu[5] = array( __('Total Enrolments'), 'upload_files', 'total-enrolments.php', '', 'menu-top menu-icon-media', 'menu-media', 'dashicons-format-standard' );
$menu[6] = array( __('New Aspirant Enrolment'), 'upload_files', 'new-aspirant-enrolments.php', '', 'menu-top menu-icon-media', 'menu-media', 'dashicons-format-standard' );
$menu[7] = array( __('Certification Wise Enrolment'), 'upload_files', 'certification-wise-enrolments.php', '', 'menu-top menu-icon-media', 'menu-media', 'dashicons-format-standard' );
$menu[8] = array( __('Certifications Issued'), 'upload_files', 'certifications-issued.php', '', 'menu-top menu-icon-media', 'menu-media', 'dashicons-format-standard' );
$menu[9] = array( __('Growth Rate Analysis'), 'upload_files', 'gra.php', '', 'menu-top menu-icon-media', 'menu-media', 'dashicons-format-standard' );
$menu[10] = array( __('Total Revenue'), 'upload_files', 'total-revenue.php', '', 'menu-top menu-icon-media', 'menu-media', 'dashicons-format-standard' );
$menu[11] = array( __('Date Span Revenue'), 'upload_files', 'date-span-revenue.php', '', 'menu-top menu-icon-media', 'menu-media', 'dashicons-format-standard' );
$menu[12] = array( __('Control Panel'), 'upload_files', 'control-panel.php', '', 'menu-top menu-icon-media', 'menu-media', 'dashicons-format-standard' );

$menu[13] = array('', 'read', 'separator1', '', 'wp-menu-separator' );

$menu[20] = array( __('Media'), 'upload_files', 'upload.php', '', 'menu-top menu-icon-media', 'menu-media', 'dashicons-admin-media' );
...
$menu[21] = array( __('Links'), 'manage_links', 'link-manager.php', '', 'menu-top menu-icon-links', 'menu-links', 'dashicons-admin-links' );
